"""
created on 9 Abril 11:34:56 2024
@author:Jesus Alejandro Montes Aguila
"""
"""
Este código genera datos de ejemplo en forma de círculos con ruido y un factor
de separación entre clases. Luego visualiza estos datos y entrena un modelo
SVM (Support Vector Machine) con un kernel RBF (Radial Basis Function) para
clasificar los datos en dos clases. Finalmente, muestra las fronteras de
...
# Importa la función make_circles del módulo datasets de la biblioteca sklearn
from sklearn.svm import SVC
# Importa la clase SVC (Support Vector Classifier) del módulo svm de la biblioteca sklearn
...
def plot_decision_boundaries(modelo, X, y):
    ...
    Z = modelo.predict(np.c_[xx.ravel(), yy.ravel()])  # Realiza predicciones para cada punto de la malla
